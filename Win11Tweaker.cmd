...
echo Checking Your System is Copatible For The Script...
timeout 4 > nul
cls
wmic os get version | findstr /i "7600" > nul
goto :os failed

wmic os get version | findstr /i "7601 > nul
goto :os failed

wmic os get version | findstr /i "9200" > nul
goto :os failed

wmic os get version | findstr /i "9600" > nul
goto :os failed

wmic os get version | findstr /i "10240" > nul
goto :os failed

wmic os get version | findstr /i "10586" > nul
goto :os failed

wmic os get version | findstr /i "14393" > nul
goto :os failed

wmic os get version | findstr /i "15063" > nul
goto :os failed

wmic os get version | findstr /i "16299" > nul
goto :os failed

wmic os get version | findstr /i "17134" > nul
goto :os failed

wmic os get version | findstr /i "17763" > nul
goto :os failed

wmic os get version | findstr /i "18362" > nul

wmic os get version | findstr /i "18363" > nul

wmic os get version | findstr /i "19041" > nul

wmic os get version | findstr /i "21996" > nul
echo All Checking Process is Completed.
timeout 4 > nul
cls
...
echo ---------------------------------------------------------------------------------------------------------------  
echo Type "user" To User Account Management.       | Type "hd & sd" To HDD & SSD Optimization! 
echo -------------------------------------------------------------------------------------------
echo Type "remove-package" To Remove Apps.        | Type "gpu" For GPU Optimizer!
echo ----------------------------------------------------------------------------------------
...
if %errorlevel% equ 0 (
echo                       You are using a NVIDIA GPU.
timeout 3 > nul
goto :nvidia
)
...
if %errorlevel% equ 0 (
echo                       You are using a Intel GPU.
timeout 3 > nul
goto :intel
)
...
:info
cls
echo The optimizations, Are From Everytingtech. Sub To Him His Make Optimizations.
echo This take 5 Hours To Complete. For The Optimization.
echo Would you like to exit?
set /p f=
if "%f%" == "yes" goto :exit
if "%f%" == "no" goto :question
